...
🔹 **[2026.05.21]**：`v26.0.0已发布，新增Operator Agent，覆盖算子性能调优场景`。<br>
🔹 **[2026.04.27]**：`v26.0.0.alpha1` 发布，新增 `Accuracy` / `Quantizer` Agent，覆盖精度调优与模型量化场景。<br>
🔹 **[2026.04.08]**：`v0.1.3` 发布，完成 DeepAgents 重构并增强 `Profiler` / `Minos` Agent。<br>
