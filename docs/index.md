...
| Coming soon | **Accuracy** | 精度调优：聚焦Ascend精度分析与优化，覆盖单卡，多卡，集群等场景，可处理RL训推一致性分析，loss/gnorm NaN分析等常见精度问题。 | [Accuracy说明](agents/Accuracy.md) |
| Coming soon | **Zephyr** | 聚焦 msModelSlim 量化与压缩场景，协助完成模型适配可行性与结构风险评估，辅助完成基础适配器开发。 | [Zephyr说明](agents/Zephyr.md) |
