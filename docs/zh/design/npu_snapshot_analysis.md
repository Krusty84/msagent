...
测试文件：`tests/ut/skills/ascend-npu-snapshot-analyzer/scripts/test_snapshot_to_db.py`、`tests/ut/skills/ascend-npu-snapshot-analyzer/scripts/test_snapshot_analyze.py`
