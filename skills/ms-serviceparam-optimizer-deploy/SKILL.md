...
```bash
pip install -e .                           # 1. 先装主包
pip install -e ./ms_serviceparam_optimizer[real]  # 2. 再装 optimizer 子包
```
...
```bash
pip install -e ./ms_serviceparam_optimizer[real]
```
