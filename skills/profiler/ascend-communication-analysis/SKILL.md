...
```bash
python3 skills/profiler/ascend-communication-analysis/scripts/<script>.py ...
```
...
Example:
```bash
python3 skills/profiler/ascend-communication-analysis/scripts/collect_wait_evidence.py \
