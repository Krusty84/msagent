...
def patch_third_party_prompt_defaults() -> None:
    ...
    class _CompactTodoListMiddleware(TodoListMiddleware):
        def __init__(
            self,
            *,
            system_prompt: str = _COMPACT_TODO_SYSTEM_PROMPT,
            tool_description: str = WRITE_TODOS_TOOL_DESCRIPTION,
        ) -> None:
            super().__init__(system_prompt=system_prompt, tool_description=tool_description)

    class _CompactSubAgentMiddleware(deepagents_subagents.SubAgentMiddleware):
        def __init__(self, *args, system_prompt: str | None = _COMPACT_TASK_SYSTEM_PROMPT, **kwargs) -> None:
    ...
    deepagents_graph.TodoListMiddleware = _CompactTodoListMiddleware
    deepagents_graph.SubAgentMiddleware = _CompactSubAgentMiddleware
