...
class ToolFactory:
    ...
    _BUILTIN_TOOL_PREVIEWS: tuple[ToolPreview, ...] = (
        ...
        ToolPreview("add_loop_task", "Create a session-scoped one-shot or recurring loop task"),
        ToolPreview("list_loop_tasks", "List active session-scoped loop tasks"),
        ToolPreview("cancel_loop_task", "Cancel a session-scoped loop task"),
