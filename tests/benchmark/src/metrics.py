    ...
    return {
        ...
        "token_usage": {
            ...
            "total": {
                ...
                "input_tokens": int(agent_tokens.get("input_tokens", 0))
                + int(judge_tokens.get("input_tokens", 0)),
                "output_tokens": int(agent_tokens.get("output_tokens", 0))
                + int(judge_tokens.get("output_tokens", 0)),
                "total_tokens": int(agent_tokens.get("total_tokens", 0))
                + int(judge_tokens.get("total_tokens", 0)),
            },
        },
        "tool_calls": {
