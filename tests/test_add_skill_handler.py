...
@pytest.mark.asyncio
async def test_add_skill_handler_reports_usage_when_no_args(
...
@pytest.mark.asyncio
async def test_add_skill_handler_handles_skill_install_error(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
    errors: list[str] = []
    monkeypatch.setattr(add_skill_module.console, "print_error", errors.append)
...
@pytest.mark.asyncio
async def test_add_skill_handler_handles_generic_exception(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
    errors: list[str] = []
    monkeypatch.setattr(add_skill_module.console, "print_error", errors.append)
