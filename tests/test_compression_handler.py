...
@pytest.mark.asyncio
async def test_compression_handler_reports_agent_not_found(
...
@pytest.mark.asyncio
async def test_compression_handler_reports_no_graph_when_none(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
    errors: list[str] = []
    monkeypatch.setattr(compress_module.console, "print_error", errors.append)
...
@pytest.mark.asyncio
async def test_compression_handler_reports_no_messages(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
    errors: list[str] = []
...
@pytest.mark.asyncio
async def test_compression_handler_reports_backend_unavailable(
    tmp_path: Path, monkeypatch: pytest.MonkeyPatch
) -> None:
    errors: list[str] = []
